...
class MyApp(QMainWindow):
    """
    Main application window for the Playfair cipher GUI.
    ...
    def call_api_encrypt(self) -> None:
        """
        Encrypts the plaintext using the Playfair cipher by calling the API.
    ...
    def call_api_decrypt(self) -> None:
        """
        Decrypts the ciphertext using the Playfair cipher by calling the API.
        Performs error checking for empty fields.
        """
